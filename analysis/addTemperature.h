...
void addTemperature::Init(TTree *tree)
{
   ...
   newBranches.push_back(fChain->Branch("tempChipBar", &tempChipBar, "tempChipBar/D" ));
   newBranches.push_back(fChain->Branch("tempHoldBar", &tempHoldBar, "tempHoldBar/D" ));
   newBranches.push_back(fChain->Branch("tempChipArray1", &tempChipArray1, "tempChipArray1/D" ));
   newBranches.push_back(fChain->Branch("tempHoldArray1", &tempHoldArray1, "tempHoldArray1/D" ));
   newBranches.push_back(fChain->Branch("tempChipArray2", &tempChipArray2, "tempChipArray2/D" ));
   newBranches.push_back(fChain->Branch("tempHoldArray2", &tempHoldArray2, "tempHoldArray2/D" ));
   newBranches.push_back(fChain->Branch("tempChipArray3", &tempChipArray3, "tempChipArray3/D" ));
   newBranches.push_back(fChain->Branch("tempHoldArray3", &tempHoldArray3, "tempHoldArray3/D" ));
   newBranches.push_back(fChain->Branch("tempChipArray4", &tempChipArray4, "tempChipArray4/D" ));
   newBranches.push_back(fChain->Branch("tempHoldArray4", &tempHoldArray4, "tempHoldArray4/D" ));
   newBranches.push_back(fChain->Branch("tempAir", &tempAir, "tempAir/D"));
   newBranches.push_back(fChain->Branch("tempAirRef", &tempAirRef, "tempAirRef/D"));
   newBranches.push_back(fChain->Branch("humidityRef", &humidityRef, "humidityRef/D"));
   newBranches.push_back(fChain->Branch("dewPointRef", &dewPointRef, "dewPointRef/D"));
