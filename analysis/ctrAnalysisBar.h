...
#ifndef ctrAnalysisBarNew_h
#define ctrAnalysisBarNew_h
...
public :
   ...
   ctrAnalysisBar_new(TTree *tree=0);
   virtual ~ctrAnalysisBar_new();
...
#ifdef ctrAnalysisBar_new_cxx
ctrAnalysisBar_new::ctrAnalysisBar_new(TTree *tree) : fChain(0) 
{
...
ctrAnalysisBar_new::~ctrAnalysisBar_new()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t ctrAnalysisBar_new::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t ctrAnalysisBar_new::LoadTree(Long64_t entry)
{
...
void ctrAnalysisBar_new::Init(TTree *tree)
{
...
Bool_t ctrAnalysisBar_new::Notify()
{
...
void ctrAnalysisBar_new::Show(Long64_t entry)
{
...
Int_t ctrAnalysisBar_new::Cut(Long64_t entry)
{
...
#endif // #ifdef ctrAnalysisBar_new_cxx
